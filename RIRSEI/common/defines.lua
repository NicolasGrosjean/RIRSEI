...
NDiplomacy = {
	...
	MAX_INFAMY_GAIN = 1,										-- This is the max infamy gained from a single source
...
NReligion = {
	...
	CREATE_ANTIPOPE_PRESTIGE_COST = 5000,
...
NMilitary = {
	...
	LEVY_MAINTENANCE_FACTOR = 1.4,					-- General maintenance factor for levy troops
	...
	RETINUE_CONSTANT_COST = 1.4, 					-- Retinues cost at all times.
